...
The `Employee#serial_number` getter needs to have `protected` method access so
that it can be invoked on other instances within the class definition (for
comparison in `Employee#==`).
